...
def build_model(encoder,
    ...
    text_diff_op = im_rgb_diff * tf.convert_to_tensor(image_input, dtype=tf.float32)
    ...
    loss_op = loss_scales[0] * image_loss_op + loss_scales[1] * secret_loss_op + loss_scales[2] * text_loss_op + loss_scales[3] * lpips_loss_op

    return loss_op, image_loss_op, secret_loss_op, text_loss_op, lpips_loss_op
